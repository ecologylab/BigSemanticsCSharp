...
{
    /// <summary>
    /// Test the functionality of the ported semantic operations from Java.
    /// </summary>
    [TestClass]
    public class SemanticOperationTests
    {
        ...
        /// <summary>
        /// uses an xml file that has as root a information_composition_declaration object.
        /// It iterates in the metadata objects array from information_composition_declaration object 
        /// and does the semantic operations that each metadata has. 
        /// A file of this type that is used is 
        /// MetaMetadataRepository/MmdRepository/testData/collectedExampleUrlMetadata.xml.
        /// </summary>
        [TestMethod]
