...
//		    else
            ...
            generatedDocumentTranslations	= 
			    metadataTranslationScope.GetAssignableSubset(SemanticNames.REPOSITORY_DOCUMENT_TRANSLATIONS, typeof(Document));
		    generatedMediaTranslations	=
                metadataTranslationScope.GetAssignableSubset(SemanticNames.REPOSITORY_MEDIA_TRANSLATIONS, typeof(ClippableDocument));
		    repositoryClippingTranslations =
                metadataTranslationScope.GetAssignableSubset(SemanticNames.REPOSITORY_CLIPPING_TRANSLATIONS, typeof(Clipping));
	    }
