...
{
	[SimplInherit]
	public class GisLocationDeclaration : Document
	{
		[SimplScalar]
		...
		public GisLocationDeclaration()
		{ }

		public GisLocationDeclaration(MetaMetadataCompositeField mmd) : base(mmd) { }
