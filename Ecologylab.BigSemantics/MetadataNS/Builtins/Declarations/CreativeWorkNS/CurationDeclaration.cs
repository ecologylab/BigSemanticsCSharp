...
namespace Ecologylab.BigSemantics.MetadataNS.Builtins.Declarations.CreativeWorkNS 
{
	[SimplInherit]
	public class CurationDeclaration : CreativeWork
	{
		[SimplCollection]
		...
		public CurationDeclaration()
		{ }

		public CurationDeclaration(MetaMetadataCompositeField mmd) : base(mmd) { }
