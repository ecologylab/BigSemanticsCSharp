...
namespace ecologylab.semantics.metadata.builtins.declarations  
{
	...
	[SimplInherit]
	public class MetadataDeclaration : NotificationObject
	{
		/// <summary>
		...
		public MetadataString MetaMetadataName
		{
			...
			set
			{
				if (this.metaMetadataName != value)
				{
					...
					this.RaisePropertyChanged( () => this.MetaMetadataName );
				}
			}
		}
		...
		public List<Metadata> Mixins
		{
			...
			set
			{
				...
				{
					this.mixins = value;
					this.RaisePropertyChanged( () => this.Mixins );
				}
			}
		}
		...
		public List<Metadata> LinkedMetadataList
		{
			...
			set
			{
				if (this.linkedMetadataList != value)
				{
					...
					this.RaisePropertyChanged( () => this.LinkedMetadataList );
				}
			}
		}
	}
