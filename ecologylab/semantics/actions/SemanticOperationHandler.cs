...
namespace ecologylab.semantics.actions
{
    ...
    public class SemanticOperationHandler : SemanticOperationStandardMethods
    {
        ...
        public SemanticOperationHandler(SemanticsGlobalScope semanticsScope, DocumentParser documentParser, Scope<Object> semanticOperationVariableMap)
        {
        ...
        public void TakeSemanticOperations(MetaMetadata metaMetadata, Metadata metadata, List<SemanticOperation> semanticActions)
        {
            ...
            else
            {
                ...
                //semanticOperationVariableMap.Add(TRUE_PURL, documentParser.getTruePURL());
        ...
        public void HandleSemanticOperation(SemanticOperation operation, DocumentParser parser, SemanticsGlobalScope infoCollector)
        {
            ...
            {
                Console.WriteLine("The action " + operationName + " could not be executed. Please see the stack trace for errors.");
            }
            finally
            {
                if (!requestWaiting)
        ...
        public void HandleForLoop(ForEachSemanticOperation operation, DocumentParser parser, SemanticsGlobalScope infoCollector)
        {
            try
            {
