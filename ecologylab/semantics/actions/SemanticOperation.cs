...
namespace ecologylab.semantics.actions 
{
	...
	public abstract class SemanticOperation : ElementState
	{
	    ...
	    {
            Document sourceDocument = (Document)GetArgumentObject(SemanticOperationNamedArguments.SOURCE_DOCUMENT);
...
*/
                MetadataString anchorText = (MetadataString) GetArgumentObject(SemanticOperationNamedArguments.ANCHOR_TEXT);
                ...
                MetadataString anchorContextString = (MetadataString) GetArgumentObject(SemanticOperationNamedArguments.ANCHOR_CONTEXT);
                bool citationSignificance = GetArgumentBoolean(SemanticOperationNamedArguments.CITATION_SIGNIFICANCE, false);
                float significanceVal = GetArgumentFloat(SemanticOperationNamedArguments.SIGNIFICANCE_VALUE, 1);
                bool traversable = GetArgumentBoolean(SemanticOperationNamedArguments.TRAVERSABLE, true);
                bool ignoreContextForTv = GetArgumentBoolean(SemanticOperationNamedArguments.IGNORE_CONTEXT_FOR_TV, false);
