...
namespace ecologylabSemantics.ecologylab.semantics.actions
{
    ...
    /// Operations include set_param and strip_param.
    /// author andruid
    /// </summary>
    [SimplInherit]
    ...
    public class FilterLocation : SemanticOperation
    {
        ...
        [SimplNoWrap]
        [SimplCollection]
        private List<ParamOp> paramOps;

        [SimplNoWrap]
        [SimplCollection("alternative_host")]
        private List<String> alternativeHosts;
        ...
        public override object Perform(object obj)// throws IOException
        {
            ...
            {
                Console.WriteLine("Not doing <filter_location> because this is a file: " + origLocation);
                return null;
            }
