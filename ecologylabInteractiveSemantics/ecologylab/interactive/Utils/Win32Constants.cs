...
namespace ecologylab.interactive.Utils
{
    ...
    public class NativeMethods
    {
        ...
        public static extern int SendMessageA(IntPtr hWnd, uint Msg, IntPtr wParam, IntPtr lParam);

        [DllImport("user32.dll", EntryPoint = "PostMessageA", SetLastError = true)]
        public static extern int PostMessageA(IntPtr hWnd, uint Msg, IntPtr wParam, IntPtr lParam);
